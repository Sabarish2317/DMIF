...
const CertificationsPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col gap-10  bg-gradient-to-br from-gray-50 to-white">
      <div className="relative bg-blue-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <motion.p
            ...
            className="text-lg text-blue-100 mb-10 max-w-3xl mx-auto"
          >
      ...
      {/* Level Details */}
      <section className="px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
      ...
      <section className="px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-900 to-indigo-900 text-white px-4 py-2 rounded-full text-sm font-medium mb-4">
      ...
      {/* CTA Section */}
      <section className="py-10 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900">
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => window.open("https://certifications.drmadhan.org/", "_blank")} className="bg-white cursor-pointer text-blue-900 px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-all shadow-xl flex items-center justify-center gap-2">
              Start Your Journey
...
const PathCard = ({ path }: any) => {
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-7 transition-colors hover:border-blue-900/60">
      <div className="flex flex-wrap items-start gap-4">
        <div className="w-14 h-14 rounded-2xl border border-blue-900/20 text-blue-900 flex items-center justify-center">
        ...
        <div className="flex-1 min-w-[220px]">
          <div className="flex flex-wrap items-center gap-2 mb-1">
            ...
            <span className="rounded-full bg-blue-50 px-2.5 py-0.5 text-[11px] font-semibold text-blue-900">
      ...
      <p className="mt-5 text-sm text-slate-600 leading-relaxed border-l border-blue-100 pl-4">
        {path.description}
      </p>
        ...
        {path.levels.map((level: any, idx: number) => (
          <div key={idx} className="flex gap-4">
            <div className="flex flex-col items-center">
              <span className="grid h-10 w-10 place-items-center rounded-2xl border border-blue-900/30 bg-white text-sm font-semibold text-blue-900">
                {idx + 1}
              </span>
              {idx !== path.levels.length - 1 && (
                <span className="mt-2 h-full w-px bg-blue-200"></span>
              )}
            </div>
...
const LevelCard = ({ level, index }: any) => {
  ...
  return (
    <div className="bg-white rounded-2xl border-2 border-gray-200 p-8 hover:border-blue-900 transition-all hover:shadow-xl">
      <div className="flex items-center justify-between mb-6">
        <div className="w-14 h-14 bg-blue-900 rounded-xl flex items-center justify-center">
          <Icon className="w-7 h-7 text-white" />
        </div>
        <span className="px-4 py-1 bg-blue-100 text-blue-900 rounded-full text-sm font-semibold">
          {badges[index]}
        </span>
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2 text-gray-700">
          ...
          <span className="text-sm">{6 + index * 2} weeks duration</span>
        </div>
        <div className="flex items-center gap-2 text-gray-700">
...
const SpecializationCard = ({ spec }: any) => {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl border-2 border-gray-200 p-8 hover:border-blue-900 transition-all hover:shadow-xl">
...
className="mt-6 w-full bg-blue-900 text-white py-3 cursor-pointer rounded-xl font-semibold hover:bg-blue-800 transition-all flex items-center justify-center gap-2">
        Join Waitlist
